			...
			<div class="container">
				<div class="mws-panel grid_8">
					<div class="mws-panel-header">
						<span class="mws-i-24 i-table-1">商家列表</span>
					</div>
					<div class="mws-panel-body">
						...
						<table class="mws-datatable mws-table">
							...
							<tbody>
								...
								<s:iterator value="#request.sellers">
									<tr>

										<td><s:property value="id" /></td>
										<td><s:property value="name" /></td>
										<td><s:property value="password" /></td>
										<td><s:form action="findSellerDetails.action"
												method="post">
												<s:hidden name="seller.id" value="%{id}" />
												<s:submit value="查看详细信息" theme="simple" />
											</s:form></td>
										<td><s:form action="delSeller.action" method="post">
												<s:hidden name="seller.id" value="%{id}" />
