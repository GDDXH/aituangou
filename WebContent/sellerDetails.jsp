			...
			<div class="container">
				<div class="mws-panel grid_8">
					<div class="mws-panel-header">
						<span class="mws-i-24 i-table-1">商家详细信息</span>
					</div>
					<div class="mws-panel-body">
						<table class="mws-table">
							...
							<tbody>
								...
								<td><s:property value="%{#request.sellerDetails.id}" /></td>
								<td><s:property value="%{#request.sellerDetails.name}" /></td>
								<td><s:property value="%{#request.sellerDetails.password}" /></td>
								<td><s:property value="%{#request.sellerDetails.telephone}" /></td>
								<td><s:property
										value="%{#request.sellerDetails.shop.shopid}" /></td>
								<td><s:property
										value="%{#request.sellerDetails.shop.shopname}" /></td>
