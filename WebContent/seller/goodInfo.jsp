                                    ...
                                    <td>
                                        <div style="float:left;">
                                            <form action="getGoodInfo" method="post">
                                                ...
                                                <input type="submit" value="修改" style="margin-left:100px;" class="mws-button black"/>
                                            </form>
                                        </div>
                                        <div style="float:left;">
                                            <form action="getGoodInfo" method="post">
                                                <input type="hidden" value="${id}" name="detail"/>
                                                <input type="submit" value="查看详细信息" style="margin-left:20px;margin-right:-200px;" class="mws-button black"/>
                                            </form>
                                        </div>
                                        <!--  
                                        <div style="float:left;">
                                            <form action="getGoodInfo" method="post">
                                                ...
                                                <input type="submit" value="删除" style="margin-left:20px;margin-right:-200px;" class="mws-button black"/>
                                            </form>
                                        </div>
                                        -->
                                    </td>
