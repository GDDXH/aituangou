...
<div id="mws-wrapper">
    ...
    <div id="mws-container" class="clearfix">
        <div class="container">
            <form action="getGoodInfo" method="post" style="margin-left: -90px;margin-bottom: 20px;">
                <input type="hidden" value="${session.good.id}" name="change"/>
                <input type="submit" value="修改信息" style="margin-left:100px;" class="mws-button black"/>
            </form>
            <form class="mws-form">
                        ...
                        <div class="mws-form-inline">
                            <div class="mws-form-row">
                                ...
                                <div class="mws-form-item large">
                                    <input type="text" name="good.name" class="mws-textinput" value="${session.good.name}" readonly="readonly"/>
                                </div>
                            </div>
                            ...
                            <div class="mws-form-row">
                                ...
                                <div class="mws-form-item small">
                                    <input type="text" name="good.city" class="mws-textinput" value="${session.good.city}" readonly="readonly"/>
                                </div>
                            </div>
                            ...
                            <div class="mws-form-row">
                                <label>商品种类</label>
                                <div class="mws-form-item small">
                                    <input type="text" name="good.type" class="mws-textinput" value="${session.good.type}" readonly="readonly"/>
                                </div>
                            </div>
                            ...
                            <div class="mws-form-row">
                                <label>售价</label>
                                <div class="mws-form-item">
                                    <input type="text" id="s1" name="good.price" class="mws-textinput" value="${session.good.price}" readonly="readonly"/>
                                </div>
                            </div>
                            ...
                            <div class="mws-form-row">
                                <label>数量</label>
                                <div class="mws-form-item">
                                    <input type="text" id="s2" name="good.num" class="mws-textinput" value="${session.good.num}" readonly="readonly"/>
                                </div>
                            </div>
                            ...
                            <div class="mws-form-row">
                                <label>团购价格</label>
                                <div class="mws-form-item small">
                                    <input type="text" name="gGoods.gprice" class="mws-textinput" value="${session.gGoods.gprice}" readonly="readonly"/>
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>数量</label>
                                <div class="mws-form-item small">
                                    <input type="text" name="gGoods.gnum" class="mws-textinput" value="${session.gGoods.gnum}" readonly="readonly"/>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mws-panel grid_4">
                <form class="mws-form" action="changeGoodPic" enctype="multipart/form-data" method="post">
                    <div class="mws-panel-header">
                        <span class="mws-i-24 i-eyedropper">图片</span>
                    </div>
                    <div class="mws-panel-body">
                        <div class="mws-form-inline">
                            <div class="mws-form-row">
                                <label>图片1</label>
                                <div class="mws-form-item large">
                                    <img src="../${session.good.picture}60x60.jpg"/>
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>图片2</label>
                                <div class="mws-form-item large">
                                    <img src="../${session.good.picture}80x80.jpg"/>
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>图片3</label>
                                <div class="mws-form-item large">
                                    <img src="../${session.good.picture}350x350.jpg"/>
                                </div>
                            </div>
                            <div class="mws-form-row">
                                <label>图片4</label>
                                <div class="mws-form-item large">
                                    <img src="../${session.good.picture}800x800.jpg"/>
                                </div>
                            </div>
                        </div>
                    </div>
