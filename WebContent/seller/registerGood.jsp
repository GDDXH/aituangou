...
<s:if test="%{#session.registerGoodError.equals(\"name\")}">
    <script language="JavaScript" type="text/javascript">
        alert("产品名不能为空")
    </script>
</s:if>
<s:elseif test="%{#session.registerGoodError.equals(\"city\")}">
    <script language="JavaScript" type="text/javascript">
        alert("城市不能为空")
    </script>
</s:elseif>
<s:elseif test="%{#session.registerGoodError.equals(\"price\")}">
    <script language="JavaScript" type="text/javascript">
        alert("价格存在问题")
    </script>
</s:elseif>
<s:elseif test="%{#session.registerGoodError.equals(\"number\")}">
    <script language="JavaScript" type="text/javascript">
        alert("商品数量存在问题")
    </script>
</s:elseif>
<s:elseif test="%{#session.registerGoodError.equals(\"picture\")}">
    <script language="JavaScript" type="text/javascript">
        alert("图片存在问题")
    </script>
</s:elseif>
<s:set name="registerGoodError" value="" scope="session"/>

<s:if test="%{#session.registerGoodMessage.equals(\"success\")}">
    <script language="JavaScript" type="text/javascript">
        alert("产品已提交审核")
    </script>
</s:if>
<s:elseif test="%{#session.registerGoodMessage.equals(\"fail\")}">
    <script language="JavaScript" type="text/javascript">
        alert("产品未能提交成功")
    </script>
</s:elseif>
<s:set name="registerGoodMessage" value="" scope="session"/>
...
<div id="mws-wrapper">
    ...
    <div id="mws-container" class="clearfix">
        <div class="container">
            <form class="mws-form" action="registerGood" enctype="multipart/form-data" method="post">
                <div class="mws-panel grid_4">
                    <div class="mws-panel-header">
                        <span class="mws-i-24 i-pencil">商品基本信息</span>
                    </div>
                        ...
                        <div class="mws-form-inline">
                            <div class="mws-form-row">
                                ...
                                <div class="mws-form-item large">
                                    <input type="text" name="good.name" class="mws-textinput" />
                                </div>
                            </div>
                            ...
                            <div class="mws-form-row">
                                <label>货源地</label>
                                <div class="mws-form-item large">
                                    <input type="text" name="good.city" class="mws-textinput" />
                                </div>
                            </div>
                            ...
                            <div class="mws-form-row">
                                <label>售价</label>
                                <div class="mws-form-item">
                                    <input type="text" id="s1" name="good.price" class="mws-textinput" value="0" />
                                </div>
                            </div>
                            ...
                            <div class="mws-form-row">
                                <label>数量</label>
                                <div class="mws-form-item">
                                    <input type="text" id="s2" name="number" class="mws-textinput" value="0" />
                                </div>
                            </div>
                        </div>
                    </div>
