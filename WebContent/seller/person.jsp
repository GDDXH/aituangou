...
<body>
<s:if test="%{#session.changeInfoError.equals(\"name\")}">
    <script language="JavaScript" type="text/javascript">
        alert("姓名不能为空")
    </script>
</s:if>
<s:elseif test="%{#session.changeInfoError.equals(\"telephone\")}">
    <script language="JavaScript" type="text/javascript">
        alert("联系方式不能为空")
    </script>
</s:elseif>
<s:elseif test="%{#session.changeInfoError.equals(\"shopName\")}">
    <script language="JavaScript" type="text/javascript">
        alert("店铺名不能为空")
    </script>
</s:elseif>
<s:set name="changeInfoError" value="" scope="session"/>

<s:if test="%{#session.changeInfo.equals(\"success\")}">
    <script language="JavaScript" type="text/javascript">
        alert("个人信息修改成功")
    </script>
</s:if>
<s:elseif test="%{#session.changeInfo.equals(\"fail\")}">
    <script language="JavaScript" type="text/javascript">
        alert("个人信息修改失败")
    </script>
</s:elseif>
<s:set name="changeInfo" value="" scope="session"/>
...
<div id="mws-wrapper">
    ...
    <div id="mws-container" class="clearfix">
        <div class="container">
            <form class="mws-form" action="changeInfo" method="post">
                <div class="mws-panel grid_4">
                    <div class="mws-panel-header">
                        <span class="mws-i-24 i-pencil">个人信息</span>
                    </div>
                        ...
                        <div class="mws-form-inline">
                            <div class="mws-form-row">
                                ...
                                <div class="mws-form-item large">
                                    <input type="text" class="mws-textinput" value="${session.loginUser.id}" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="mws-form-row">
                                <label>姓名</label>
                                <div class="mws-form-item large">
                                    <input type="text" name="loginUser.name" class="mws-textinput" value="${session.loginUser.name}"/>
                                </div>
                            </div>
                            ...
                            <div class="mws-form-row">
                                <label>联系方式</label>
                                <div class="mws-form-item large">
                                    <input type="text" name="loginUser.telephone" class="mws-textinput" value="${session.loginUser.telephone}"/>
                                </div>
                            </div>
                            ...
                            <div class="mws-form-row">
                                <label>店铺名</label>
                                <div class="mws-form-item large">
                                    <input type="text" name="shop.name" class="mws-textinput" value="${session.loginUser.shop.name}"/>
                                </div>
                            </div>
