        ...
        <div class="container">
            <div class="mws-panel grid_8">
                <div class="mws-panel-header">
                    <span class="mws-i-24 i-table-1">商品信息</span>
                </div>
                <div class="mws-panel-body">
                    <table class="mws-datatable mws-table">
                        ...
                        <tbody>
                        <s:iterator value="#session.orderInfo">
                            <tr class="gradeA">
                                ...
                                <td><s:property value="orderList.sumPrice"/></td>
                                <td>
                                    <s:if test="orderList.shipstate=='未发货'">
                                        <%--<div style="float:left;">--%>
                                            <%--<form action="getGoodInfo" method="post">--%>
                                                <%--<input type="hidden" value="${orderList.oid}" name="change"/>--%>
                                                <%--<input type="submit" value="发货" style="margin-left:100px;" class="mws-button black"/>--%>
                                            <%--</form>--%>
                                        <%--</div>--%>
                                        <a href="shipDetail?oid=${orderList.oid}" >未发货</a>
                                    </s:if>
                                    <s:else>
                                        <a href="shipDetail?oid=${orderList.oid}" >已发货</a>
                                    </s:else>
                                </td>
                                <td>
                                    <s:if test="orderList.recstate=='已收货'">
                                        已收货
                                    </s:if>
                                    <s:else>
                                        未收货
                                    ...
                                    <%--<div style="float:left;">--%>
                                        <%--<form action="getGoodInfo" method="post">--%>
                                            <%--<input type="hidden" value="${orderList.oid}" name="detail"/>--%>
                                            <%--<input type="submit" value="查看详细信息" style="margin-left:20px;" class="mws-button black"/>--%>
                                        <%--</form>--%>
                                    <%--</div>--%>
                                </td>
                            </tr>
