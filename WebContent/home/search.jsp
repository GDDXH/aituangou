		...
		<div class="am-container header">
			...
			<div class="nav white">
				...
				<div class="search-bar pr">
                    ...
                    <form action="search?sort=main" method="get">
	                  	...
	                  	<div class="theme-popover">														
							...
							<ul class="select">
								<p class="title font-normal">
									<span class="fl"><s:property value="name"/> </span>
									<span class="total fl">搜索到<strong class="num"><s:property value="number"/> </strong>件相关商品</span>
								</p>
								<div class="clear"></div>
							...
							<div class="search-content">
								<div class="sort">
									<li class="first"><a title="综合" href="search?name=${name}&sort=main">综合排序</a></li>
									<li><a title="销量" href="search?name=${name}&sort=sale">销量排序</a></li>
									<li><a title="价格" href="search?name=${name}&sort=price">价格优先</a></li>
									<li class="big"><a title="评价" href="search?name=${name}&sort=comment">评价为主</a></li>
								</div>
								<div class="clear"></div>

								<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
                                    <s:iterator value="#session.goods">
                                        <li>
                                            <a href="introduce?id=${id}">
                                                <div class="i-pic limit">
                                                    <img src="..${picture}350x350.jpg" />
                                                    <p class="title fl"><s:property value="name"/> </p>
                                                    <p class="price fl">
                                                        <b>¥</b>
                                                        <strong><s:property value="price"/> </strong>
                                                    </p>
                                                    <p class="number fl">
                                                        销量<span><s:property value="sales"/> </span>
                                                    </p>
