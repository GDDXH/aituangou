			...
			<div class="container">
				<div class="mws-panel grid_8">
					<div class="mws-panel-header">
						<span class="mws-i-24 i-table-1">会员详细信息</span>
					</div>
					<div class="mws-panel-body">
						<table class="mws-table">
							...
							<tbody>
								...
								<td><s:property value="%{#request.buyerDetails.id}" /></td>
								<td><s:property value="%{#request.buyerDetails.name}" /></td>
								<td><s:property value="%{#request.buyerDetails.password}" /></td>
								<td><s:property value="%{#request.buyerDetails.telephone}" /></td>
								<td><s:property value="%{#request.buyerDetails.address}" /></td>
