...
<title>My JSP 'sellerDetailsList.jsp' starting page</title>
</head>
<body>
	<s:if test="%{#request.upinfor.equals(\"fail\")}">
		...
		<div id="mws-sidebar">
			...
			<div id="mws-navigation">
				<ul>
					...
					<li class="active"><a href=# class="mws-i-24 i-chart">维护商家信息</a>
						<ul>
			...
			<div class="container">
				<div class="mws-panel grid_8">
					<div class="mws-panel-header">
						<span class="mws-i-24 i-table-1">更新商家信息</span>
					</div>
					<div class="mws-panel-body">
						...
						<table class="mws-datatable mws-table">
							...
							<tbody>
								<s:iterator value="#request.sellersDetails" id="h">
									<tr>
										<s:form action="updSeller" method="post" theme="simple">
											<td><s:property value="%{id}" /></td>
											<td>
												<s:textfield type="text" name="seller.name" class="mws-textinput" value="%{name}"/>
											</td>
											<td>
												<s:textfield type="text" name="seller.password" class="mws-textinput" value="%{password}"/>
											</td>
											<td>
												<s:textfield type="text" name="seller.telephone" class="mws-textinput" value="%{telephone}"/>
											</td>
											<td>
												<s:textfield type="text" name="seller.shop.shopid" class="mws-textinput" value="%{shop.shopid}"/>
											</td>
											<td><s:property value="%{shop.shopname}" /></td>
											<td>
												<s:hidden name="seller.id" value="%{id}" /> 
												<s:hidden name="seller.shop.shopname" value="%{shop.shopname}" />
