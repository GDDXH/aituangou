	...
	<div id="mws-wrapper">
		...
		<div id="mws-sidebar">
			...
			<div id="mws-navigation">
				<ul>
					<li class="active">
                	<a href=# class="mws-i-24 i-home">维护会员信息</a>
                	<ul>
					...
					<div class="mws-panel-body">
						...
						<table class="mws-datatable mws-table">
							...
							<tbody>
								...
								<s:iterator value="#request.buyers">
									<tr>

										<td><s:property value="id" /></td>
										<td><s:property value="name" /></td>
										<td><s:property value="password" /></td>
										<td><s:form action="findBuyerDetails.action"
												method="post">
												<s:hidden name="buyer.id" value="%{id}" />
												<s:submit value="查看详细信息" theme="simple" />
											</s:form></td>
										<td><s:form action="delBuyer.action" method="post">
												<s:hidden name="buyer.id" value="%{id}" />
