...
<div id= "mws-themer">
	...
	<div id="mws-wrapper">
		...
		<div id="mws-container" class="clearfix">
			<div class="container">
				<form name="addBform" class="mws-form" action="addBuyer.action"
					method="post">
					<div class="mws-panel grid_8">
						<div class="mws-panel-header">
							<span class="mws-i-24 i-table-1">添加会员</span>
						</div>
						<div class="mws-panel-body">
							<table class="mws-table">
								...
								<tbody>
									...
									<tr class="gradeX">
										<td><input type="text" name="buyer.id"
											class="mws-textinput" /></td>
										<td><input type="text" name="buyer.password"
											class="mws-textinput" /></td>
										<td><input type="text" name="buyer.name"
											class="mws-textinput" /></td>
										<td class="center"><input type="text" name="buyer.telephone"
											class="mws-textinput" /></td>
										<td class="center"><input type="text" name="buyer.address"
											class="mws-textinput" /></td>
									</tr>
