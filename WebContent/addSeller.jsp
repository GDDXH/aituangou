...
<title>My JSP 'sellerList.jsp' starting page</title>
<script type="text/javascript">
	...
	if (ValidatePhone(addBform.seller.btel.value) == false) {
...
<body>
	...
	<div id="mws-wrapper">
		...
		<div id="mws-container" class="clearfix">
			<div class="container">
				<form name="addBform" class="mws-form" action="addSeller.action"
					method="post">
					<div class="mws-panel grid_8">
						<div class="mws-panel-header">
							<span class="mws-i-24 i-table-1">添加商家</span>
						</div>
						<div class="mws-panel-body">
							<table class="mws-table">
								...
								<tbody>
									...
									<tr class="gradeX">
										<td><input type="text" name="seller.id"
											class="mws-textinput" /></td>
										<td><input type="text" name="seller.password"
											class="mws-textinput" /></td>
										<td><input type="text" name="seller.name"
											class="mws-textinput" /></td>
										<td class="center"><input type="text" name="seller.telephone"
											class="mws-textinput" /></td>
										<td class="center"><input type="text" name="seller.shop.shopid"
											class="mws-textinput" /></td>
									</tr>
