...
<body>
	<s:if test="%{#request.upinfor.equals(\"success\")}">
		<script language="JavaScript" type="text/javascript">
			alert("商品信息修改成功")
		</script>
	</s:if>
	<s:elseif test="%{#request.upinfor.equals(\"fail\")}">
		<script language="JavaScript" type="text/javascript">
			alert("商品信息修改失败")
		</script>
	</s:elseif>
			...
			<div class="container">
				<div class="mws-panel grid_8">
					<div class="mws-panel-header">
						<span class="mws-i-24 i-table-1">更新商品信息</span>
					</div>
						...
						<table class="mws-datatable mws-table">
							...
							<tbody>
								...
								<s:iterator value="#request.goods">
									<tr>
										<s:form action="updGoods.action" method="post" theme="simple">

											<td><s:property value="id" /></td>
											<td>
												<s:textfield type="text" name="good.name" class="mws-textinput" value="%{name}"/>
											</td>
											<td>
												<s:textfield type="text" name="good.type" class="mws-textinput" value="%{type}" style="width: 114px;"/>
											</td>
											<td>
												<s:textfield type="text" name="good.price" class="mws-textinput" value="%{price}" style="width: 113px; "/>
											</td>
											...
											<td><s:property value="shop.shopid" /></td>
											<td>
												<s:hidden name="good.id" value="%{id}" /> 
												<s:hidden name="good.num" value="%{num}" />
												<s:hidden name="good.sales" value="%{sales}" />
												<s:hidden name="good.city" value="%{city}" /> 
												<s:hidden name="good.picture" value="%{picture}" /> 
												<s:hidden name="good.score" value="%{score}" /> 
												<s:hidden name="good.shop.shopid" value="%{shop.shopid}" />
												<s:hidden name="good.state" value="%{state}" />
