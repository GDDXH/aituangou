...
<body>
	...
	<s:elseif test="%{#request.addinfor.equals(\"fail\")}">
		<script language="JavaScript" type="text/javascript">
			alert("商品审核失败")
		</script>
	</s:elseif>
	<s:elseif test="%{#request.addinfor.equals(\"success\")}">
		<script language="JavaScript" type="text/javascript">
			alert("商品审核成功")
		</script>
	</s:elseif>
	<s:elseif test="%{#request.delinfor.equals(\"success\")}">
		<script language="JavaScript" type="text/javascript">
			alert("商品删除成功")
		</script>
	</s:elseif>
			...
			<div class="container">
				<div class="mws-panel grid_8">
					<div class="mws-panel-header">
						<span class="mws-i-24 i-table-1">待审核商品列表</span>
					</div>
					<div class="mws-panel-body">
						...
						<table class="mws-datatable mws-table">
							...
							<tbody>
								...
								<s:iterator value="#request.goodchecks">
									<tr>
										...
										<td>
											<s:form action="checkPass.action" method="post" theme="simple">
												<s:hidden name="goodcheck.id" value="%{id}" />
												<s:submit value="审核通过" theme="simple" />
											</s:form>
											
										</td>
										<td>
											<s:form action="unCheckPass.action" method="post" theme="simple">
												<s:hidden name="goodcheck.id" value="%{id}" />
												<s:submit value="审核不通过" theme="simple" />
											</s:form>
										</td>
									</tr>
								</s:iterator>
