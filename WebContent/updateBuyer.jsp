			...
			<div class="container">
				<div class="mws-panel grid_8">
					<div class="mws-panel-header">
						<span class="mws-i-24 i-table-1">会员列表</span>
					</div>
					<div class="mws-panel-body">
						...
						<table class="mws-datatable mws-table">
							...
							<tbody>
								<s:iterator value="#request.buyers" id="h">
									<tr>
										<s:form action="updBuyer" method="post" theme="simple">
											<td>
												<s:hidden name="buyer.id" value="%{id}" /> 
												<s:property value="%{id}" />
											</td>
												
											<td>
												<s:textfield  name="buyer.name" class="mws-textinput" value="%{name}"/>
											</td>
											<td>
												<s:textfield  type="text" name="buyer.password" class="mws-textinput" value="%{password}"/>
											</td>
											<td>
												<s:textfield  type="text" name="buyer.telephone" class="mws-textinput" value="%{telephone}"/>

											</td>
											<td>
												<s:textfield  type="text" name="buyer.address" class="mws-textinput" value="%{address}"/>
